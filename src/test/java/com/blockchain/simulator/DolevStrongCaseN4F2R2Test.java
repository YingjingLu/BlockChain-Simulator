...
public class DolevStrongCaseN4F2R2Test {
    public static final String CASE_NAME = "dolevstrong_n_4_f_2_r_2";

    private final String caseFolder;

    public DolevStrongCaseN4F2R2Test() {
    ...
    @Test
    public void runDolevStrongCaseN4F2R2Test() throws IOException, IllegalArgumentException, ParseException {
